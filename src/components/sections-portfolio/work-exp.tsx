                        ...
                        {experiences.map((exp, index) => {
                            ...
                            return (
                                <div
                                    key={index}
                                    ref={ref}
                                    className={`relative flex items-center w-full ${isLeft ? "justify-start pr-0 md:pr-0" : "justify-end pl-0 md:pl-0"
                                        }`}
                                >
                                    {/* Dot */}
                                    ...
                                    <div
                                        className={`absolute top-1/2 h-[2px] transition-all duration-700 ${isLeft ? "right-1/2" : "left-1/2"
                                            }`}
                                        style={{
                                    ...
                                    >
                                        ...
                                        <ul className="p-3 space-y-5">
                                            {exp.expbullet.map((feature, index) => (
                                        ...
                                        <div className="flex flex-wrap gap-2 my-3">
                                            {exp.tags.map((tag, index) => (
                                                <span key={index} className="px-2 py-1 text-xs bg-gray-800 text-gray-300 rounded-sm text-center">
                                                {tag}
                                                </span>
                                            ))}
                                        </div>
