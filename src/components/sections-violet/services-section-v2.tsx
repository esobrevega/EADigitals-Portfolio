...
export const ServicesSection2V = () => {
  return (
    <section
      id="services"
      className="relative py-20 px-4 z-10 bg-black"
    >
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8">
        {/* Left: Big SERVICES text */}
        <div className="hidden lg:flex col-span-2 justify-center items-center">
          <h1
            className="font-bold rotate-270 bg-gradient-to-r from-white via-violet-200 to-purple-300 bg-clip-text text-transparent"
        ...
        <div className="col-span-1 lg:col-span-10">
          <div className="text-center lg:text-left mb-16 ml-10">
